...
forEach(callbackfn: (value: OptionsGeneric[KeyOf<OptionsGeneric>], key: KeyOf<OptionsGeneric>, map: this) => void, thisArgument?: unknown): void
...
const ProcessedOptionsMap: new <OptionsGeneric extends Record<string, unknown> = Record<string, unknown>>(options?: OptionsGeneric) => {
[Symbol.iterator](): MapIterator<[Extract<keyof OptionsGeneric, string>, OptionsGeneric[Extract<keyof OptionsGeneric, string>]]>
entries(): MapIterator<[Extract<keyof OptionsGeneric, string>, OptionsGeneric[Extract<keyof OptionsGeneric, string>]]>
forEach(callbackfn: (value: OptionsGeneric[Extract<keyof OptionsGeneric, string>], key: Extract<keyof OptionsGeneric, string>, map: any) => void, thisArgument?: unknown): void
get<KeyGeneric extends Extract<keyof OptionsGeneric, string>>(key: KeyGeneric): OptionsGeneric[KeyGeneric]
has<KeyGeneric extends Extract<keyof OptionsGeneric, string>>(key: KeyGeneric): this is ProcessedOptionsMapShape<OptionsGeneric & {[Key in KeyGeneric]-?: Exclude<OptionsGeneric[Key], undefined>}>
keys(): MapIterator<Extract<keyof OptionsGeneric, string>>
...
export interface TypedFactory extends SchemaMethods {<SetupGeneric extends Setup = {}>(): Schema<SetupGeneric>}
...
type DefaultsOf<SetupGeneric extends Setup> = SetupGeneric extends {defaults: infer DefaultsGeneric extends Dict$1} ? DefaultsGeneric : {}
type Dict$1<ValueGeneric = unknown> = Record<string, ValueGeneric>
type ExtractSetup<InputGeneric> = InputGeneric extends {readonly [schemaBrandSymbol]: infer SetupGeneric extends Setup} ? SetupGeneric : InputGeneric extends (...args: any) => infer ReturnGeneric ? ExtractSetup<ReturnGeneric> : InputGeneric extends Setup ? NormalizeSetup<InputGeneric> : never
...
type IsEmptyRecord<InputGeneric extends Dict$1> = [keyof InputGeneric] extends [never] ? true : false
...
type NormalizationsOf<SetupGeneric extends Setup> = SetupGeneric extends {normalizations: infer NormalizationsGeneric extends Dict$1} ? NormalizationsGeneric : {}
...
type NormalizerReturnTypes<InputGeneric> = InputGeneric extends Record<string, (...args: any) => any> ? {[Key in keyof InputGeneric]: ReturnType<InputGeneric[Key]>} : {}
...
type OptionalOf<SetupGeneric extends Setup> = SetupGeneric extends {optional: infer OptionalGeneric extends Dict$1} ? OptionalGeneric : {}
...
type ReplaceValues<InputGeneric extends Dict$1, ReplacementGeneric extends Dict$1> = Simplify<{[Key in keyof InputGeneric]: Key extends keyof ReplacementGeneric ? ReplacementGeneric[Key] : InputGeneric[Key]}>
...
type RequiredOf<SetupGeneric extends Setup> = SetupGeneric extends {required: infer RequiredGeneric extends Dict$1} ? RequiredGeneric : {}
...
type ToSetupFromInput<InputGeneric> = [InputGeneric] extends [undefined] ? {} : InputGeneric extends Dict$1 ? HasSetupKey<InputGeneric> extends true ? NormalizeSetup<{
defaults: InputGeneric extends {defaults: infer DefaultsGeneric extends Dict$1} ? DefaultsGeneric : {}
...
optional: InputGeneric extends {optional: infer OptionalGeneric extends Dict$1} ? OptionalGeneric : {}
optionalKeys: InputGeneric extends {optionalKeys: infer KeysGeneric extends KeyList} ? KeysGeneric : never
required: InputGeneric extends {required: infer RequiredGeneric extends Dict$1} ? RequiredGeneric : {}
requiredKeys: InputGeneric extends {requiredKeys: infer KeysGeneric extends KeyList} ? KeysGeneric : never
}> : {defaults: InputGeneric} : {}
export type {Dict$1 as Dict, Dict$1 as OptisDict, Parameter as OptisParameter, Processed as OptisProcessed, ProcessedMap as OptisProcessedMap, Schema as OptisSchema, Setup as OptisSetup, TypedFactory as OptisTypedFactory}
export {optis as default}
